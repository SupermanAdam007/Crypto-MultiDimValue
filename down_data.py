...
class Downloader(object):
	...
	def get_tradeHistory(self, currencyPair, t_from, t_to, verbose=True):
		"""
		currencyPair: list of coins from ... ex.: ['BTC', 'USD']
	...
	def get_tradeHistory_json(self, currencyPair, t_from, t_to, verbose=True):
		return self.get_tradeHistory(currencyPair, t_from, t_to, verbose).json()